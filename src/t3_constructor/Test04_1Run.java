...
public class Test04_1Run {
	public static void main(String[] args) {
		//Scanner sc = new Scanner(system.in)
		Test04_1 t4_1 = new Test04_1("그랜져"); //생성자 변수 =new 생성자(생성자 이름 = 클래스 이름)(필드)
